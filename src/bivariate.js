...
function handleJsonBiv(data) {
    ...
    // Add legend
    if(selected_values["mot"]!='h'|selected_values["mot"]!='e'|selected_values["mot"]!='g'|selected_values["mot"]!='c'|selected_values["mot"]!='ugs'){
    ...
    if (selected_values["justice"] == "amenities") {
