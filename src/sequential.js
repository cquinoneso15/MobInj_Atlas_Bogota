...
function handleJsonSeq(data,name) {
    ...
    if (selected_values['justice']=="amenities"|selected_values['justice']=="ava"|selected_values['justice']=="stations"|selected_values['justice']=="mob_inj_score"){ function getColor(d) {
